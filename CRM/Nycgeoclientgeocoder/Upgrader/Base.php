 ...
 */
class CRM_Nycgeoclientgeocoder_Upgrader_Base {
  ...
  static public function instance() {
    if (! self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Nycgeoclientgeocoder_Upgrader(
        'unhp.nycgeoclientgeocoder',
        realpath(__DIR__ .'/../../../')
      );
    }
   ...
   *
   * @code
   * CRM_Nycgeoclientgeocoder_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
