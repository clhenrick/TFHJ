 ...
 */
define( 'CIVICRM_UF_DSN'           , 'mysql://root:root@localhost:3306/cooper_wp?new_link=true' );
 ...
 *
 */
//define( 'CIVICRM_DSN'          , 'mysql://crmdaniel:homerule!2@coopersquare.org/cooper_crm?new_link=true' );
define( 'CIVICRM_DSN'          , 'mysql://root:root@localhost/cooper?new_link=true' );
...
$civicrm_root = '/Applications/MAMP/htdocs/wp-content/plugins/civicrm/civicrm/';
define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/Applications/MAMP/htdocs/wp-content/plugins/files/civicrm/templates_c/' );
 ...
 */
define( 'CIVICRM_SITE_KEY', 'dcbe416278a264caa9baaebeeedfb89f' );
 ...
 */
// define( 'CIVICRM_MAIL_LOG', '/var/www/vhosts/coopersquare.org/httpdocs/wp-content/plugins/files/civicrm/templates_c//mail.log' );
