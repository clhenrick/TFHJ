	...
	{if $form.is_recur}
	    <div class="crm-section {$form.is_recur.name}-section">
			<div class="content">
				...
				<!--Added by MTL to get start date for recurring contributions-->
				<!-- Start -->
				{if $form.recurring_start_date.html}
				  <br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{ts}{$form.recurring_start_date.label}{/ts}&nbsp;{include file="CRM/common/jcalendar.tpl" elementName=recurring_start_date}
				  <br /><span class="description">{ts}Please specify the date of your first payment for your recurring contribution. You can leave the date blank if you want to make the first payment today.{/ts}
				{/if}
				<!--  End  -->
...
function enablePeriod ( ) {
	...
	// Added by MTL, Start date for recurring contributions
