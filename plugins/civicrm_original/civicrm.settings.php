...
if (!defined('CIVICRM_UF_DSN')) {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:root@localhost/cooper_crm?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  define( 'CIVICRM_DSN'          , 'mysql://root:root@localhost/cooper_crm?new_link=true');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'a424b6976428f7fe4a2b3cb0ab8006ce');
}
...
// define( 'CIVICRM_MAIL_LOG', '/Applications/MAMP/htdocs/wp-content/plugins/files/civicrm/templates_c//mail.log');
// }
